...
graphics.enemy_decals = function(map_color, item_name)
  ...
  {
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-00.png",
      width = 508,
      height = 364,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-01.png",
      width = 494,
      height = 316,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-02.png",
      width = 508,
      height = 360,
      shift = util.by_pixel(0, 0),
      hr_version =
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-03.png",
      width = 508,
      height = 360,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-04.png",
      width = 422,
      height = 362,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-05.png",
      width = 456,
      height = 292,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-06.png",
      width = 482,
      height = 322,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-07.png",
      width = 508,
      height = 360,
      shift = util.by_pixel(0, 0),
      hr_version =
  ...
  {
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-00.png",
      width = 508,
      height = 360,
      shift = util.by_pixel(0, -2),
      hr_version =
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-01.png",
      width = 470,
      height = 288,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-02.png",
      width = 422,
      height = 272,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-03.png",
      width = 484,
      height = 344,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-04.png",
      width = 402,
      height = 360,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-05.png",
      width = 426,
      height = 250,
      shift = util.by_pixel(16, 2),
      hr_version =
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-06.png",
      width = 458,
      height = 300,
    ...
    {
      filename = "__biters-for-resources__/graphics/enemy-decal/enemy-decal-t-07.png",
      width = 504,
      height = 358,
